...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (!passwordRegex.test(password)) errors.password = "Contraseña inválida (mín. 8 caracteres, mayúscula, minúscula, número y símbolo).";
  ...
  const handleRegister = async (e) => {
    ...
    const userData = { name, lastName, surname, email, phone, password, role: 'STUDENT' };
